...
* Kinds of fog:
  - Black fog: Forgetfulness. Lose track of where you are.
  - Red fog: Violence. The war rushes over you.
 
## Wall-hugger game
A 2D platformer in which you are a blob of slime climbing the walls of a sewer.
* An exploration of fluid/goo physics

## Swarm game
A game in which you control a swarm of 'bees'.
* An exploration of flocking mechanics.
